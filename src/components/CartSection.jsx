      ...
      {items.length > 0 ? (
        <>
          <div className=" min-h-full mb-24">
            ...
            <div className=" flex flex-col mt-2 mx-48 ">
              ...
              <div>
                <div className=" grid grid-cols-[3fr_2fr]">
                            ...
                            >
                              <div className=" flex justify-between px-4 py-4">
                                <div>
                                  ...
                                  <div className=" text-[#1d8802] text-[14px] font-bold">
                                    You saved{" "}
                                    <span className=" font-Krala">₹</span>
                                    {item.product?.discountPrice -
                                      item.product?.price}
                                  ...
                                  <div className=" flex">
                                    <div className=" flex items-center border-[1px] border-[#ccc] rounded-md mt-4 px-2 text-[12px] font-Montserrat mr-4">
                                      <span>Size :</span>
                                      <select
                  ...
                  <div className=" flex flex-col w-full mx-4">
                    ...
                    <div className=" flex flex-col border-[1px] border-[#ccc]">
                      ...
                      <div className=" flex justify-between p-3 font-poppins text-[13px] text-[#292d35]">
                        <div className=" flex flex-col justify-between min-h-[100px] mb-8">
