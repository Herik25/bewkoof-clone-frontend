    ...
    <div>
      <div className="my-12 mx-44">
        <div className="flex flex-col bg-[#fffbfb] border-[1px] pt-6 px-8 border-[#fcf6f6] shadow-md rounded-md">
          ...
          <div className=" flex justify-between py-5 border-b-[1px] border-b-[#ccc]">
            <div className=" flex">
          ...
          <div className=" flex items-center justify-between">
            <div className=" flex items-center">
              <div className=" flex items-center text-[#727272] font-bold px-16 py-4 border-r-[1px] border-r-[#ccc] cursor-pointer">
              <div className=" h-5  w-20 bg-gradient-to-r from-gray-300 via-gray-200 to-gray-300 rounded-md animate-gradient-shine"></div>
              </div>
              <div className=" ml-4 h-3  w-24 bg-gradient-to-r from-gray-300 via-gray-200 to-gray-300 rounded-md animate-gradient-shine"></div>
            </div>
