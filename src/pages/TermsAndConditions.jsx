...
function TermsAndConditions() {
  return (
    <div className=" font-Montserrat">
      <Navbar />
      <div className=" mt-16 mx-2 md:mx-8 lg:mx-32 xl:mx-48">
        <div className=" text-xs">
          <h2 className=" font-bold text-3xl text-center mt-20 mb-4">
            Terms of Use
          </h2>
          <ul>
            <li className="lists text">
              ...
              Please check this page regularly to take notice of any changes we
          ...
          <ul>
            ...
            <li className="lists text">
              ...
              services, we consider similar to those that you are either already
              using, or have enquired about, or that may interest you or any
              combination thereof. Upon registering with us, we may contact you
              by electronic means (i.e. either e-mail or SMS or telephone or any
              combination thereof) to inform about these services.
            </li>
          </ul>
          <ul>
            ...
            <li className="lists text">
              ...
              sharing and/or listing purpose and we take no responsibility of
              ...
              party websites.
              <br /> We disclaim all liabilities and take no responsibility for
              the content that may be posted on such third party websites by the
          ...
          <ul>
            ...
            <li className="lists text">
              Our&nbsp;
              <a href="/privacy-policy-and-disclaimer" className=" font-bold">
                Privacy Policy
              </a>{" "}
              incorporated by reference in these Terms of Service, sets out how
              we will use personal information you provide to us. By using this
              Website, you agree to be bound by the Privacy Policy, and warrant
              that all data provided by you is accurate and up to date.
            </li>
          </ul>
          <ul>
            <li className=" text-sm font-bold mt-4 underline">
            ...
            <li className="lists text">
              ...
              colours accurately, we cannot guarantee that your computer's
              display of the colours accurately reflect the colour of the items.
              Your items may vary slightly from those images. All sizes and
              measurements of items are approximate; however, we do make every
              effort to ensure they are accurate as possible. We take all
              reasonable care to ensure that all details, descriptions and
          ...
          <ul>
            ...
            <li className="lists text">
              ...
              paid for the goods, you will receive a full refund. The products
              available on the website are for retail sales, intended for end
              user consumption and is in no away available for resale.
              <br />
              <br /> Additionally, prices for items may change from time to time
              without notice. However, these changes will not affect orders that
              have already been dispatched. The price of an item includes VAT,
              goods and service tax (or similar taxes) at the prevailing rate
              for which we are responsible as a seller. Please note that the
              prices listed on the website are only applicable for items
              purchased on the website and not through any other source.
            </li>
          </ul>
          <ul>
            ...
            <li className="lists text">
              ...
              sufficient funds to fulfil the transaction. Goods will not be
              dispatched until this pre-authorization check has been completed.
              Your card will be debited once the order has been accepted. For
              any further payment related queries, please check our{" "}
          ...
          <ul>
            ...
            <li className="lists text">
              ...
              where you are ordering from. An estimated delivery time is
              displayed on the order summary page. On placing your order, you
              will receive an email containing a summary of the order and also
              the estimated delivery time to your location. Sometimes, delivery
              may take longer due to unforeseen circumstances. In such cases, we
              will proactively reach out to you by e-mail and SMS. However, we
              will not be able to compensate for any mental agony caused due to
              delay in delivery.{" "}
            </li>
          </ul>
          <ul>
            ...
            <li className="lists text">
              If you change your mind about any items purchased, you can return
              them to us. For more information on Returns and Refund, please
              refer to our{" "}
              <a href="/contact-us" className="conactUsLink">
                Return Policy
              </a>
          ...
          <ul>
            ...
            <li className="lists text">
              ...
              products shall be owned absolutely by the Company.{" "}
            </li>
          </ul>
          <ul>
            <li className=" text-sm font-bold mt-4 underline">
          ...
          <ul>
            ...
            <li className="lists text">
              ...
              damages or costs arising from your use of this website, your br
              /each of these Terms of Service, or infringement of any
          ...
          <ul>
            ...
            <li className="lists text">
              ...
              future access if we determine that you have violated these Terms
              of Service or any other policies. If you or the Company terminates
              your use of any service, you shall still be liable to pay for any
              service that you have already ordered till the time of such
              termination.
            </li>
          </ul>
          <ul>
            ...
            <li className="lists text">
              IN NO EVENT WILL THE COMPANY OR IT'S REPRESENTATIVES BE LIABLE FOR
          ...
          <ul>
            ...
            <li className="lists text">
              We may sometimes offer trials or other promotional memberships to
              ...
              <table className=" border-[1px] border-black text-xs">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className=" pr-4">
                      Half-yearly (valid for 6 months from date of activation)
                    </td>
          ...
          <ul>
            ...
            <li className="lists text">
              ...
              applicable taxes are included in either or both of the membership
              fee.
              <br />
              <br />
            </li>
