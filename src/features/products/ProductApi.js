...
export function fetchWomenDresssByFilters(filter) {
  ...
  return new Promise(async (resolve) => {
    const response = await fetch("/products?category=dress&gender=women&" + queryString);
    const data = await response.json();
    resolve({ data });
  });
}
...
export function fetchWomenJoggersByFilters(filter) {
  ...
  return new Promise(async (resolve) => {
    const response = await fetch("/products?category=joggers&gender=women&" + queryString);
    const data = await response.json();
    resolve({ data });
  });
}
...
export function fetchWomenTopsByFilters(filter) {
  ...
  return new Promise(async (resolve) => {
    const response = await fetch("/products?category=top&gender=women&" + queryString);
    const data = await response.json();
    resolve({ data });
  });
}
...
export function fetchWomenTshirtByFilters(filter) {
  ...
  return new Promise(async (resolve) => {
    const response = await fetch("/products?category=tshirt&gender=women&" + queryString);
    const data = await response.json();
    resolve({ data });
  });
}
